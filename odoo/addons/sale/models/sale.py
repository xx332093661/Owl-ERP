...
class SaleOrder(models.Model):
    ...
    def _prepare_invoice(self):
        ...
        if self._context.get('company_id'):
            account_id = self.partner_invoice_id.with_context(force_company=self._context['company_id']).property_account_receivable_id.id
        else:
        ...
        if not account_id:
            ...
            if receivable_id:
                ...
                account_id = account_obj.search(domain).id
        ...
        invoice_vals = {
            ...
            'payment_type': self._context.get('payment_type', False), # 付款条款
        }
        return invoice_vals
...
class SaleOrderLine(models.Model):
    ...
    def _prepare_invoice_line(self, qty):
        ...
        res = {}
        if self._context.get('company_id'):
            account = self.product_id.with_context(force_company=self._context['company_id']).property_account_income_id
        else:
