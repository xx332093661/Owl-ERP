...
class StockAcrossMove(models.Model):
    ...
    picking_in_count = fields.Integer('调入分拣', related='purchase_order_id.delivery_count')
    picking_out_count = fields.Integer('调出分拣', related='sale_order_id.picking_count')
