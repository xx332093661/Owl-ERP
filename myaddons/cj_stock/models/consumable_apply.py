...
class StockConsumableApply(models.Model):
    ...
    warehouse_id = fields.Many2one('stock.warehouse', '申请仓库', required=1, readonly=1, states=READONLY_STATES, track_visibility='always', default=_get_default_warehouse_id, domain=lambda self: [('company_id', 'child_of', self.env.user.company_id.id)])
