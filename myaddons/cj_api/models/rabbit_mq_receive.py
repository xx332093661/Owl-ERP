...
MQ_SEQUENCE = {
    ...
    'MUSTANG-ERP-RECIPIENT-QUEUE': 10,  # 客情单
    ...
    'MUSTANG-ERP-CUSTOMER-RETENTION-STATUS-PUSH': 17,  # 客情单状态

    'WMS-ERP-CHECK-STOCK-QUEUE': 30, # 盘点单
    'MUSTANG-ERP-ALLOCATE-RECEIPT-QUEUE': 40,  # 中台往ERP推送出入库单
    'MUSTANG-ERP-ALLOCATE-ACTUALINOUT-QUEUE': 41, # 中台推送出库执行结果给ERP
    'MUSTANG-ERP-ALLOCATE-CANCEL-QUEUE': 42,  # 中台推送出入库取消事件给EPR
    'MUSTANG-ERP-ALLOCATE-CANCELRESULT-QUEUE': 43,  # 中台推送流程取消结果给ERP
